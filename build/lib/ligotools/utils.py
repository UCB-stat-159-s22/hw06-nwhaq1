...
def plot_figures(fs, template_p, template_c, time, template_offset, strain_L1, strain_H1, dt, bb, ab, normalization, make_plots, strain_H1_whitenbp, eventname, plottype, tevent, strain_L1_whitenbp):
    NFFT = 4*fs
