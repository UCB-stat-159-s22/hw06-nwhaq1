...
template_match = plot_figures(fs, template_p, template_c, time, template_offset, strain_L1, strain_H1, dt, bb, ab, normalization, make_plots, strain_H1_whitenbp, eventname, plottype, tevent, strain_L1_whitenbp)
template_H1 = template_match
template_L1 = template_match
...
# for testing purposes of reqshift
strain_H1_whitenbp.tofile('ligotools/tests/data/strain_H1_whitenbpa.dat')
strain_L1_whitenbp.tofile('ligotools/tests/data/strain_L1_whitenbpa.dat')
